    ...
    <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-1000">
      <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center h-16">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-blue-150 rounded-lg flex items-center justify-center text-white font-bold text-xl">
            L
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-150 font-semibold text-base">
            DU
          </div>
        </div>
      </div>
